...
namespace SpellByte
{
    ...
    void ObjectGroup::init(tinyxml2::XMLElement *groupElt, ObjectFactory *objFactory, Ogre::SceneNode *parentNode, ObjectGroup *parentGroup)
    {
        ...
        if( groupElt->BoolAttribute("disabled") )
        {
    ...
    void ObjectGroup::saveGroup(tinyxml2::XMLDocument *xmlDoc, tinyxml2::XMLElement *elt)
    {
    ...
    void ObjectGroup::loadSubGroups(tinyxml2::XMLElement *groupElt, ObjectFactory *objFactory)
    {
    ...
    void ObjectGroup::addObject(const Object *addObj)
    {
    ...
    void ObjectGroup::addObjectGroup(const ObjectGroup *addObjGroup)
    {
